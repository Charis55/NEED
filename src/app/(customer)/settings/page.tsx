...
export default function SettingsPage() {
  ...
  const handleSaveAccount = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === "auth/requires-recent-login") {
        ...
        showAlert(err.message || "Failed to save account settings", "error");
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleCropComplete = async (croppedFile: File) => {
    ...
    try {
      ...
      // Update in user/artisan document (if applicable, though Firebase Auth handles the main photoURL)
  ...
  return (
    <div className="max-w-xl mx-auto pt-16 px-6 pb-20 selection:bg-[var(--color-brutal-pink)] selection:text-black">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative mb-4">
              <div className="w-32 h-32 rounded-full border-4 border-black overflow-hidden bg-[var(--color-brutal-yellow)] brutal-shadow">
                {uploadingImage ? (
              ...
              <label className="absolute bottom-0 right-0 w-10 h-10 bg-[var(--color-brutal-pink)] border-4 border-black rounded-full flex justify-center items-center cursor-pointer hover:scale-110 transition-transform">
      ...
      {activeTab === "notifications" && (
        <div className="bg-[var(--color-brutal-pink)] border-4 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
